...
namespace CodeCommerce\UserData\Controller\Admin;
...
class Userdataexport extends AdminDetailsController
{
    ...
    public function exportUserData()
    {
        ...
        if ($f) {
            ...
            if (Registry::getConfig()->getRequestParameter('sendUserMail')) {
                $this->sendUserEmail();
            }
        }
    ...
    public function getOxUser()
    {
        ...
        if ($aRes = DatabaseProvider::getDb(DatabaseProvider::FETCH_MODE_ASSOC)->getAll($sSql))
            return $aRes[0];
